...
\begin{lstlisting}
https://github.com/Gandubs/Signals-and-Systems/blob/master/audio%20filter/codes/Ananth-singing.wav
\end{lstlisting}
\item 
...
\begin{lstlisting}
https://github.com/Gandubs/Signals-and-Systems/blob/master/audio%20filter/codes/2.2.c
\end{lstlisting} 
The following code plots x[n] and $y[n]$
\begin{lstlisting}
https://github.com/Gandubs/Signals-and-Systems/blob/master/audio%20filter/codes/2.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Gandubs/Signals-and-Systems/blob/master/audio%20filter/codes/3.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Gandubs/Signals-and-Systems/blob/master/audio%20filter/codes/4.2.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Gandubs/Signals-and-Systems/blob/master/audio%20filter/codes/4.4.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
...
%
\begin{lstlisting}
https://github.com/Gandubs/Signals-and-Systems/blob/master/audio%20filter/codes/4.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Gandubs/Signals-and-Systems/blob/master/audio%20filter/codes/5_sol.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Gandubs/Signals-and-Systems/blob/master/audio%20filter/codes/5.4.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Gandubs/Signals-and-Systems/blob/master/audio%20filter/codes/5.5.py\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Gandubs/Signals-and-Systems/blob/master/audio%20filter/codes/6.1.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Gandubs/Signals-and-Systems/blob/master/audio%20filter/codes/6.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Gandubs/Signals-and-Systems/blob/master/audio%20filter/codes/6_filter_response.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\end{align}
\begin{lstlisting}
https://github.com/Gandubs/Signals-and-Systems/blob/master/audio%20filter/codes/analog_filt.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Gandubs/Signals-and-Systems/blob/master/audio%20filter/codes/6.2_pole-zero.py
\end{lstlisting}
\begin{figure}[H]
\centering
